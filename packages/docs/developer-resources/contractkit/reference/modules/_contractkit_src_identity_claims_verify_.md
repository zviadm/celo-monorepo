...
▸ **verifyDomainRecord**(`claim`: [DomainClaim](_contractkit_src_identity_claims_claim_.md#domainclaim), `address`: string, `dnsResolver`: dnsResolverFunction): *Promise‹undefined | "Unable to verify domain claim"›*
