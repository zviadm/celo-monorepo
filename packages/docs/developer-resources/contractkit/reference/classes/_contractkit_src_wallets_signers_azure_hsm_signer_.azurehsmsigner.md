...
\+ **new AzureHSMSigner**(`keyVaultClient`: [AzureKeyVaultClient](_contractkit_src_wallets_signers_azure_key_vault_client_.azurekeyvaultclient.md), `keyName`: string): *[AzureHSMSigner](_contractkit_src_wallets_signers_azure_hsm_signer_.azurehsmsigner.md)*
...
Name | Type |
------ | ------ |
`keyVaultClient` | [AzureKeyVaultClient](_contractkit_src_wallets_signers_azure_key_vault_client_.azurekeyvaultclient.md) |
`keyName` | string |
